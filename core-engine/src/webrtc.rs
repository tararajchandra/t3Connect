...
pub async fn init_webrtc(tx: mpsc::Sender<String>) -> Result<WebRTCContext, Box<dyn std::error::Error>> {
    ...
    let video_task = tokio::spawn(async move {
        ...
        // Initialize Encoder
        let encoder_res = crate::encoder::HardwareEncoder::new(width, height, fps, 5_000_000);
